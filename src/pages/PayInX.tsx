      ...
      <main className="flex-grow">
        <section className="w-full py-20 px-6 md:px-16">
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-8">Pay in X</h1>
            <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto">
              Pay only 25% upfront and the remaining amount in 3-18 convenient EMIs. 
              Make higher-priced products more accessible to your customers.
            </p>
            
            <div className="bg-gray-100 p-8 rounded-lg mt-12">
              <h2 className="text-3xl font-bold mb-6">Coming Soon</h2>
              <p className="text-lg text-gray-600">
                Our Pay in X feature is currently in development. Contact us to learn more and get early access.
              </p>
            </div>
